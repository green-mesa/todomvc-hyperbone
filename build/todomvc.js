 ...
 */
  ...
  require.register("extended-view", function(exports, require, module) {
    /*
 ...
 */
  ...
  require.register("filter-model", function(exports, require, module) {
  ...
  require.register("todo-model", function(exports, require, module) {
  ...
  require.register("app-model", function(exports, require, module) {
    ...
    var App = require("hyperbone-model").Model.extend({
      ...
      updateTotals: function() {
        // recalculate totals
        var length = this.get("items").length, completed = this.get("items").select(function(el) {
